...
Future<void> saveSupplier(Supplier supplier) async {
  DocumentReference docRef = await _firestore.collection(supplierCollection).add(supplier.toMap());
  ...
  Future<Supplier?> getSupplierById(String id) async {
    DocumentSnapshot doc = await _firestore.collection(supplierCollection).doc(id).get();
    if (doc.exists) {
  ...
  Future<void> updateSupplier(Supplier supplier) async {
    await _firestore.collection(supplierCollection).doc(supplier.id).update(supplier.toMap());
  }
